...
export class OrderController {
  ...
  @Put(':id/updateStatus')
  // @RequiresRoles(['admin', 'system'])
  updatePaymentStatus(@Param('id') id: string, @Body() updateeStatusDto: UpdateOrderStatusDto) {
    return this.orderService.updateStatus(+id, updateeStatusDto);
  }

  @Put(':id/updateShip')
  // @RequiresRoles(['admin', 'system'])
  updateShipInfo(@Param('id') id: string, @Body() updateeOrderShipDto: UpdateOrderShipDto) {
